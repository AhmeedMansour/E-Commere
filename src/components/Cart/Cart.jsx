      ...
      <div className="relative overflow-x-auto shadow-md sm:rounded-lg my-3">
        ...
        <div className="overflow-x-auto">
          <table className="w-full text-sm text-left text-gray-500 dark:text-gray-400">
            <thead className="text-xs text-gray-300 uppercase bg-green-700 dark:bg-green-800">
              <tr>
            ...
            <tbody>
              {cartData.map((cart, index) => (
                <tr 
                  key={cart._id || index} 
                  className="bg-white border-b border-gray-200 hover:bg-gray-50 dark:bg-gray-800 dark:border-gray-700 dark:hover:bg-gray-700"
                >
                  ...
                  <td className="px-4 py-4 text-center">
                    <div className="flex items-center justify-center">
                      ...
                      <span className="mx-2 px-3 py-1 bg-gray-50 dark:bg-gray-700 border border-gray-300 dark:border-gray-600 text-gray-900 dark:text-gray-100 text-sm rounded-lg text-center">
                        {cart.count}
                      </span>
                      <button
                        onClick={() => updateCart(cart.product._id, cart.count + 1)}
                  ...
                  <td className="px-4 py-4 text-center">
                    <button
                      className="px-3 py-2 text-xs sm:text-sm font-semibold text-white bg-red-600 rounded-lg shadow-md transition-all duration-300 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-400"
        ...
        <div className="flex flex-wrap justify-between items-center px-4 py-4 md:mx-8 lg:mx-10">
          <h2 className="text-lg sm:text-xl font-semibold text-green-600 dark:text-green-400">
            Total Price: <span className="text-black dark:text-white">£E {totalPrice}</span>
          </h2>
          <button
            onClick={() => deleteAllCart()}
            className="flex items-center px-4 py-3 text-xs sm:text-sm font-semibold text-white bg-red-600 rounded-lg shadow-md transition-all duration-300 hover:bg-red-700 dark:bg-red-700 dark:hover:bg-red-800 focus:outline-none focus:ring-2 focus:ring-red-400"
          >
        ...
        <div className="flex justify-center items-center px-4 py-4">
          <button
            ...
            className="px-5 py-3 text-xs sm:text-sm font-semibold text-white bg-green-600 rounded-lg shadow-md transition-all duration-300 hover:bg-green-700 dark:bg-green-700 dark:hover:bg-green-800 focus:outline-none focus:ring-2 focus:ring-green-400"
          >
            Check Out
          </button>
        </div>
