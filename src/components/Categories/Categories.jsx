...
{catLoading? (
        ...
        {categories.map((cat) => (
          <Link to={"/categories"} key={cat._id} className="relative group overflow-hidden rounded-xl">
            <img src={cat.image} className="h-[400px] w-full rounded-xl object-cover" alt={cat.name} />
            {/* overlay div */}
